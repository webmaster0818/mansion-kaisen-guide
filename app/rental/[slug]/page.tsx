  ...
  return (
    <div className="flex flex-col min-h-screen">
      ...
      <div className="bg-white border-b border-border">
        <Breadcrumb
          items={[
            { label: "賃貸ガイド", href: "/rental/how-to-install/" },
            { label: rental.title },
          ]}
        />
      </div>
      ...
      <main className="flex-1">
        ...
        <section className="bg-gradient-to-br from-primary/5 via-white to-accent/5 py-12 md:py-16">
          <div className="max-w-4xl mx-auto px-4">
            ...
            <p className="text-muted text-lg">{rental.description}</p>
          </div>
        </section>
        ...
        <section className="py-10 bg-white">
          <div className="max-w-4xl mx-auto px-4">
            <h2 className="text-lg font-bold text-foreground mb-4">関連ガイド</h2>
            <div className="grid md:grid-cols-3 gap-4">
              ...
              >
                <p className="text-sm font-bold text-foreground mb-1">賃貸での光回線の引き方</p>
                <p className="text-xs text-muted">完全ガイド</p>
              </a>
              <a
                href="/rental/permission/"
                className="block p-4 rounded-xl border border-border hover:border-primary hover:bg-primary/5 transition-colors"
              >
                <p className="text-sm font-bold text-foreground mb-1">管理会社への許可申請</p>
                <p className="text-xs text-muted">テンプレ付き</p>
              </a>
              <a
                href="/rental/alternatives/"
                className="block p-4 rounded-xl border border-border hover:border-primary hover:bg-primary/5 transition-colors"
              >
                <p className="text-sm font-bold text-foreground mb-1">光回線NGの場合の代替案</p>
                <p className="text-xs text-muted">5つの選択肢</p>
              </a>
            </div>
          </div>
        </section>
